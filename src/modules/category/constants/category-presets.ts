...
export const categoryPresetsByPlanType: Record<PlanType, CategoryPreset[]> = {
  ...
  saving: [
    ...
    ...mapIncomeCategory(['Nap quy', 'Thu nhap', 'Tien lai', 'Hoan tien', 'Khac']),
  ],
  birthday: mapExpenseCategory([
    'Dia diem',
    'An uong',
    'Banh sinh nhat',
    'Trang tri',
  ...
  shared_living: mapExpenseCategory([
    'Tien nha',
    'Dien',
    'Nuoc',
    'Internet',
  ...
  general: mapExpenseCategory(['An uong', 'Di chuyen', 'Mua sam', 'Dich vu', 'Giai tri', 'Khac']),
};
