...
export const planCardVisualsByType: Record<PlanType, PlanCardVisual> = {
  debt: {
    ...
    progressTrackClassName: 'bg-[var(--color-surface-subtle)]',
  ...
  project: {
    icon: Briefcase,
    iconBgClassName: 'bg-gradient-to-br from-teal-500 to-cyan-400',
    iconFgClassName: 'text-white',
    accentTextClassName: 'text-[#0c48d7]',
    progressTrackClassName: 'bg-[var(--color-surface-subtle)]',
  ...
  general: {
    icon: Folder,
    iconBgClassName: 'bg-[var(--color-surface-overlay)]',
    iconFgClassName: 'text-[var(--color-text-primary)]',
    accentTextClassName: 'text-[#0c48d7]',
    progressTrackClassName: 'bg-[var(--color-surface-subtle)]',
    progressFillClassName: 'bg-[var(--color-brand-primary)]',
  },
};
