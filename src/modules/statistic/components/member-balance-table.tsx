    ...
    <Card>
      ...
      <div className="grid gap-3">
        {statistic.memberBalances.map((row) => (
          <div
            key={row.memberId}
            className="grid gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm sm:grid-cols-[1.2fr_1fr_1fr_1fr]"
          >
            ...
            <div className={row.balance >= 0 ? 'font-medium text-emerald-700' : 'font-medium text-rose-700'}>
