            ...
            className={cn(
              ...
              isSelected
                ...
                : status === 'completed'
                  ...
                  : 'border-[var(--color-milestone-upcoming-border)] bg-[var(--color-milestone-upcoming)] text-[var(--color-milestone-upcoming-foreground)] hover:border-[var(--color-border-default)]',
            )}
            key={milestone.id}
            ...
            <div className="flex flex-col gap-4 p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-1">
                  ...
                  <p
                    className={cn(
                      'text-sm',
                      isSelected ? 'text-[var(--color-milestone-selected-muted)]' : 'text-[var(--color-text-secondary)]',
                    )}
                  >
                ...
                <Badge
                  className={
                    status === 'completed'
                      ? 'bg-[var(--color-success-soft)] text-[var(--color-status-success)]'
                      : status === 'cancelled'
                        ? ''
                        : status === 'in_progress'
                ...
                <div>
                  <p
                    className={cn(
                      ...
                      isSelected ? 'text-[var(--color-milestone-selected-muted)]' : 'text-[var(--color-text-muted)]',
                    )}
                  >
                    Đã chi
                  </p>
              ...
              {canManagePlan ? (
                <div className="flex flex-wrap justify-end gap-2">
                  <Button
                    className={isSelected ? 'border border-white/20 bg-transparent text-white hover:bg-[color:color-mix(in_srgb,var(--color-surface-default)_14%,transparent)]' : ''}
